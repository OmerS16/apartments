...
average_price['ratio'] = average_price['price_mean'] / average_price['sq_m_mean']
average_price_2_rooms = average_price.query('rooms == 2 & count > 1').sort_values('ratio')

average_price.to_csv(r"C:\Users\Omer\Desktop\Coding\yad2 scraper\database_apartments.csv", index=False, encoding='utf-8-sig')
